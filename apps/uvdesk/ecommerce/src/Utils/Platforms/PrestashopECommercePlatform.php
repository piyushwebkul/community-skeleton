...
class PrestashopECommercePlatform implements ECommercePlatformInterface
{
    const TEMPLATE = __DIR__ . "/../../../templates/configs/prestashop/template.php";

    private $collection = [];

    public function getQualifiedName() : string
    {
        return 'PrestashopECommerceCollection';
    }
    ...
    {   
        ...
        foreach ($attributes['channels'] as $attributes) {
            ($eCommerceChannel = new PrestashopECommerceChannel($attributes['id']))
    ...
    {   
        ...
        ($eCommerceChannel = new PrestashopECommerceChannel())
            ->setDomain($attributes['domain'])
